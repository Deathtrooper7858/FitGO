...
export function MedicalConditionsStep({ value: data, onChange }: StepProps) {
  ...
  const selected = useMemo(() => data.medicalConditions || [], [data.medicalConditions]);
  ...
  const GROUPS: ConditionGroup[] = [
    {
      id: 'metabolic_cardio',
      title: t('onboarding.medCategories.metabolicCardio', 'METABOLIC & CARDIOVASCULAR'),
      items: [
        {
          id: 'diabetes_type1',
          labelKey: 'onboarding.medicalItems.diabetes_type1',
          defaultLabel: 'Type 1 Diabetes',
          icon: <Activity size={20} color="#3B82F6" />,
          color: '#3B82F6',
        },
        {
          id: 'diabetes_type2',
          labelKey: 'onboarding.medicalItems.diabetes_type2',
          defaultLabel: 'Type 2 Diabetes',
          icon: <Droplets size={20} color="#06B6D4" />,
          color: '#06B6D4',
        },
        {
          id: 'hypertension',
          labelKey: 'onboarding.medicalItems.hypertension',
          defaultLabel: 'Hypertension (High Blood Pressure)',
          icon: <Heart size={20} color="#EF4444" />,
          color: '#EF4444',
        },
        {
          id: 'cardiovascular',
          labelKey: 'onboarding.medicalItems.cardiovascular',
          defaultLabel: 'Cardiovascular Disease',
          icon: <Heart size={20} color="#F43F5E" />,
          color: '#F43F5E',
        },
        {
          id: 'obesity',
          labelKey: 'onboarding.medicalItems.obesity',
          defaultLabel: 'Obesity (Clinical Diagnosis)',
    ...
    {
      id: 'digestive_renal',
      title: t('onboarding.medCategories.digestiveRenal', 'DIGESTIVE & RENAL'),
      items: [
        {
          id: 'ibs',
          labelKey: 'onboarding.medicalItems.ibs',
          defaultLabel: 'Irritable Bowel Syndrome (IBS)',
          icon: <Stethoscope size={20} color="#8B5CF6" />,
          color: '#8B5CF6',
        },
        {
          id: 'renal',
          labelKey: 'onboarding.medicalItems.renal',
          defaultLabel: 'Renal / Kidney Disease',
    ...
    {
      id: 'hormonal_blood',
      title: t('onboarding.medCategories.hormonalBlood', 'HORMONAL & BLOOD'),
      items: [
        {
          id: 'thyroid',
          labelKey: 'onboarding.medicalItems.thyroid',
          defaultLabel: 'Hypo / Hyperthyroidism',
          icon: <Zap size={20} color="#EAB308" />,
          color: '#EAB308',
        },
        {
          id: 'anemia',
          labelKey: 'onboarding.medicalItems.anemia',
          defaultLabel: 'Anemia',
  ...
  const toggle = useCallback(
    (id: string) => {
      ...
      onChange({ medicalConditions: next.length === 0 ? [] : next });
    },
    [selected, onChange]
  );
  ...
  const commitCustomText = (text: string) => {
    ...
    if (trimmed) {
      onChange({ medicalConditions: [...base, `custom:${trimmed}`] });
    } else {
      onChange({ medicalConditions: base });
    }
  };
  ...
  return (
    <View style={step.container}>
      <View style={step.headerSection}>
        <FloatingHeroIcon
          icon={<Heart size={44} color="#EF4444" />}
          color="#EF4444"
          glowColor="#F43F5E"
        />
        <Text style={[step.title, { color: colors.textPrimary }]}>
          {t('onboarding.medicalConditionsTitle', 'Any medical conditions?')}
        </Text>
        <Text style={[step.sub, { color: colors.textSecondary }]}>
          {t('onboarding.medicalConditionsSub', 'Select all that apply — you can skip this step')}
        </Text>
      </View>
        ...
        <Animated.View entering={FadeInUp.delay(80).springify().damping(18)}>
          ...
          >
            ...
            <View style={{ flex: 1, backgroundColor: 'transparent' }}>
              ...
              >
                {t('onboarding.medicalItems.none', 'None')}
              </Text>
              <Text style={[step.optionSub, { color: colors.textSecondary }]}>
                {t('onboarding.noMedicalConditions', 'No known medical conditions')}
              </Text>
            </View>
            <View
              style={[
          ...
          >
            ...
            >
              <View
                style={[
                  ...
                  {
                    backgroundColor: colors.background,
                    borderColor: isOtherActive ? '#EF444450' : colors.border + '30',
                  },
                ]}
              >
              ...
              <Text
                style={[
                  step.optionTitle,
                  { color: colors.textPrimary, flex: 1, fontSize: 15, marginBottom: 0 },
                  isOtherActive && { color: '#EF4444', fontWeight: '800' },
                ]}
              >
              ...
              <View
                style={[
                  step.radioOuter,
                  {
                    borderColor: isOtherActive ? '#EF4444' : colors.border,
                    backgroundColor: isOtherActive ? '#EF4444' : 'transparent',
                    borderWidth: 2,
                  },
                ]}
              >
            ...
            <TextInput
              ...
              style={[
                ...
                {
                  backgroundColor: colors.background,
                  borderColor: customFocused ? '#EF4444' : colors.border,
                  color: colors.textPrimary,
                },
              ]}
